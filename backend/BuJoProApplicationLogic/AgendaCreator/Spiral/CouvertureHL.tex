...
\usepackage[paperheight=8.5in,paperwidth=6in,margin=0in]{geometry}
\usepackage{tikz}
...
\begin{tikzpicture}[remember picture, overlay]
    % Image de fond
    \node[anchor=center, opacity=0.6] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{imageCouverture}};
