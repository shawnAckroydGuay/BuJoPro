...
\thispagestyle{empty}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \foreach \y in {\hauteurLigneJourSemaine, 1.604, ..., 8.5} {
            \draw[gray!90] (0in, -\y  in) to (6in, -\y in);
        }
        
        \node[anchor=north west, font=\bfseries] at (0.5in, 0in) {Jeudi};
        \node[anchor=north west, font=\bfseries] at (1.85in, 0in) {Vendredi};
        \node[anchor=north west, font=\bfseries] at (3.425in, 0in) {Samedi};
        \node[anchor=north west, font=\bfseries] at (4.85in, 0in) {Dimanche};
        %Jeudi - Vendredi 
